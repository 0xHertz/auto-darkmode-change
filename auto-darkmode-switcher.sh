...
# ls /usr/share/themes/
# ls /usr/share/icons/
LIGHT_GTK_THEME="Yaru-blue"
DARK_GTK_THEME="Yaru-blue-dark"

LIGHT_ICON_THEME="WhiteSur-light"
DARK_ICON_THEME="WhiteSur-dark"
...
LIGHT_SHELL_THEME="Yaru-blue"
DARK_SHELL_THEME="Yaru-blue-dark"
...
LIGHT_CURSOR_THEME="MacOS"
DARK_CURSOR_THEME="MacOS"
...
if [ $COMPARABLE_NOW -gt $COMPARABLE_SUNRISE_TODAY ] && [ $COMPARABLE_NOW -lt $COMPARABLE_SUNSET_TODAY ]; then
	...
	gsettings --schemadir $HOME/.local/share/gnome-shell/extensions/user-theme@gnome-shell-extensions.gcampax.github.com/schemas set org.gnome.shell.extensions.user-theme name "$DARK_SHELL_THEME"
